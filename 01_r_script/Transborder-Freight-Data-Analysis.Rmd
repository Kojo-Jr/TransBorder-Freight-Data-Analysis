...
The bar chart above shows the distribution of freight value (in trillions of USD) by transportation mode for the past 4 years in the US states. Each mode is represented by a distinct colour:
...
-   Freight Value vs. Freight Charges (0.45): A moderate positive correlation suggests that higher freight value2021: is moderately associated with higher freight charges.
