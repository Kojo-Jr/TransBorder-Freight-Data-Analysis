---
title: "Trans-borderFreight Data Analysis"
...
# First, summarize freight value by YEAR, USASTATE and DISAGMOT
...
ggplot(us_trade_mode_top10_agg, aes(x = USASTATE, y = Total_Value / 1e6, fill = factor(DISAGMOT))) +
  geom_bar(stat = "identity", position = "dodge") +
 # scale_y_continuous(labels = label_number(scale = 1e-6, suffix = "M")) +  # Display values in millions
  scale_fill_manual(
...
-   High Point: Freight value peaks in March,likely due to increased shipment demand before global COVID-19 lock-downs.
