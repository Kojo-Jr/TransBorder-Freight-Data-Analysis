...
This table shows the yearly statistics for the years 2020 to 2024, focusing on three metrics: Avg_Value, Avg_ShipWt (Average Shipping Weight) and Avg_Freight_Charges.
...
us_state_totals <- yearly_data %>%
  group_by(USASTATE) %>%
  summarise(Overall_Value = sum(VALUE, na.rm = TRUE), .groups = "drop") %>%
...
The bar chart above shows the distribution of freight value (in millions of USD) by transportation mode for the past 4 years in the US states. Each mode is represented by a distinct colour:
