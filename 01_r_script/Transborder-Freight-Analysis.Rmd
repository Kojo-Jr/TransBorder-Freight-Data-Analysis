...
```{r}
# Since they are still missing NA's use column-specific conditions or individual imputation conditions. This means that each column is evaluated independently for missing values, rather than requiring a combined condition (i.e. both columns missing) for imputation.
# In this code: For MEXSTATE, the condition checks if MEXSTATE is NA and COUNTRY equals 2010. For CANPROV, the condition checks if CANPROV is NA and COUNTRY equals 1220.
